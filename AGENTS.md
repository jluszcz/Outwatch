...
- `frontend/` — Preact + htm frontend source
    - `AGENTS.md` — The frontend's conventions and gotchas; loads only when working on files under `frontend/`, keeping them out of every unrelated session's context
...
`frontend/AGENTS.md`, which loads when working on files under `frontend/`.
...
- **Never commit real names or email addresses.** The real roster (people's
  ...
  AGENTS.md, `frontend/AGENTS.md`, design docs and plans under `docs/`, tests,
